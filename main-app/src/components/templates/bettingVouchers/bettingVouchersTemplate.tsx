...
import { betting_balkanBet, betting_meridian, betting_merkurXtip, betting_soccerBet } from '@/assets/images'
    ...
    return (
        <Container isFullHeight={true}>
            ...
            <div 
                ...
                />
                <AvailableServices title={t('bettingVouchers.availableServices')} images={[betting_balkanBet, betting_soccerBet, betting_merkurXtip, betting_meridian]} />
