...
import { betting_balkanBet, betting_meridian, betting_merkurXtip, betting_soccerBet, gaming_josServisaUskoro, gaming_playstation, gaming_steam, gaming_xbox } from '@/assets/images'
...
export const Betting: Story = {
    args: {
        ...
        images: [betting_balkanBet, betting_soccerBet, betting_merkurXtip, betting_meridian]
...
export const Gaming: Story = {
    args: {
        ...
        images: [gaming_xbox, gaming_steam, gaming_playstation, gaming_josServisaUskoro]
    } as AvailableServicesProps
}